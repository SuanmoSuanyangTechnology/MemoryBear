...
async def upload_workspace_file(
    *,
    ...
    file_too_large_status: int = status.HTTP_413_CONTENT_TOO_LARGE,
) -> dict[str, str]:
    """
    Upload a file to workspace storage and persist FileMetadata.

    Shared by /api/storage/files, /api/storage/share/files and /v1/app/files.
    """
