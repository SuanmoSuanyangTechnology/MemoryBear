...
async def ingest_contexts_via_full_pipeline(
    ...
    Args:
        ...
        chunker_strategy: Optional chunker strategy; defaults to env EVAL_CHUNKER_STRATEGY.
        embedding_name: Optional embedding model ID; defaults to env EVAL_EMBEDDING_ID.
...
async def main_from_contexts(contexts: List[str], group_id: str):
    ...
    success = await ingest_contexts_via_full_pipeline(
        ...
        embedding_name=os.getenv("EVAL_EMBEDDING_ID"),
