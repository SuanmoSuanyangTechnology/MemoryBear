...
class MemoryWriteNode(BaseNode):
    def __init__(self, node_config: dict[str, Any], workflow_config: dict[str, Any], down_stream_node: list[str]):
        super().__init__(node_config, workflow_config, down_stream_node)
