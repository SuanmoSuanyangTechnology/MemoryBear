...
class ChunkOutputMode(str, Enum):  # noqa: UP042 - preserve legacy Enum string semantics.
    NORMAL = "normal"
    QA = "qa"
    PARENT_CHILD = "parent_child"


class LogicalChunkType(str, Enum):  # noqa: UP042 - preserve legacy Enum string semantics.
    TEXT = "text"
    TABLE = "table"
    IMAGE = "image"


class ImageVisionScope(str, Enum):  # noqa: UP042 - preserve legacy Enum string semantics.
    EMBEDDED = "embedded"
    DIRECT = "direct"


class ParsedBlockType(str, Enum):  # noqa: UP042 - preserve legacy Enum string semantics.
    HEADING = "heading"
    TEXT = "text"
    LIST = "list"
...
def build_chunk_context(
    ...
    **kwargs,
    ...
    raw_output_mode = explicit_output_mode or (
        ChunkOutputMode.PARENT_CHILD
        if parser_config.get("parent_child_mode", False)
        else ChunkOutputMode.NORMAL
    )
