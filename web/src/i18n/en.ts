...
`,
    ...
    workflow: {
      ...
      cognitiveUpgrading: {
        ...
        memoryWriteDesc: 'Write this conversation round to memory for future retrieval. Typically placed after the LLM response, configure user and assistant messages, and select the memory configuration to store.',
