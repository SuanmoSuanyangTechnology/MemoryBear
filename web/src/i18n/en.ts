...
`,
    ...
    appShare: {
      ...
      active: 'Active',
      inactive: 'Inactive',
      noSharedOut: 'No shared records',
      noSharedToMe: 'No apps shared with me',
      sharedAppCount: '{{count}} app(s) shared to this workspace',
      unshareAll: 'Remove ALL',
      unshareAllTitle: 'Bulk Unshare',
      confirmUnshareAll: 'Remove all apps shared to "{{name}}"? This cannot be undone.',
      unshareAllSuccess: 'All shares removed',
      confirmUnshare: 'Confirm unshare? The target workspace will lose access to this app',
      confirmRemoveShared: 'Remove this shared app from your workspace? This action cannot be undone.',
      removeAll: 'Remove ALL',
      removeAllTitle: 'Remove All Shared Apps',
      confirmRemoveAll: 'Remove all shared apps from "{{name}}"? You will no longer be able to use these apps. This action cannot be undone.',
      removeAllSuccess: 'All shared apps removed',
      useShare: 'Use Share',
      useShareDesc: 'Can test run, cannot view internals',
      copyShare: 'Copy Share',
      copyShareDesc: 'Copy full replica, free to edit',
      readonlyViewTip: 'Shared App (Read-only)',
    },
  },
};
