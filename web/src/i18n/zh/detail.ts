export const detail = {
    ...
    package: {
      ...
      // 增购资源包
      resourcePackTitle: '增购资源包',
      resourcePackDesc: '资源包按当前套餐剩余有效期同步生效，到期后可随套餐一起续费',
      viewOwnedResource: '查看已有资源',
      chooseCategory: '选择扩容规格',
      chooseCategoryDesc: '选择规格与数量后，确认加入购物车',
      currentTotalQuota: '当前可用总额度',
      perShareQuota: '每份资源额度',
      buyQuantity: '购买数量',
      addQuota: '数增',
      confirmAddCart: '确认加入购物车',
      confirmUpdateCart: '更新购物车',
      goToOrder: '去确认订单',
      cartTotal: '合计',
      cartAddedItems: '已选 {{count}} 项资源包',
      end_user_pack: '终端用户扩容包',
      end_user_pack_desc: '提高可记忆终端用户上限',
      knowledge_pack: '知识库存储包',
      knowledge_pack_desc: '扩展文档与向量数据容量',
      api_ops_pack: 'API 并发包',
      api_ops_pack_desc: '提升 API OPS 频次上限',
      workspace_pack: '工作空间扩容包',
      workspace_pack_desc: '增加独立业务工作空间',
      perShareAmount: '每份额度',
      newTotalAmount: '新增总额',
      validity: '有效期',
      followCurrentPlan: '跟随当前套餐',
      share: '份',
      cartListTitle: '购物车清单',
      clearCart: '清空购物车',
      cartCleared: '已清空购物车',
      clearCartConfirm: '确定清空购物车中的全部资源包吗？',
      inCartTip: '已加入购物车 {{count}} 份',
    },
}
