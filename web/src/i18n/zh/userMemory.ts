export const userMemory = {
    userMemory: {
      ...
      time_desc: '时间倒序',
      occurred_asc: '发生时间正序',
      occurred_desc: '发生时间倒序',
      recorded_asc: '记录时间正序',
      recorded_desc: '记录时间倒序',
      all_time_start: '开始时间',
      all_time_end: '结束时间',
      key_node_time_start: '发生开始时间',
      key_node_time_end: '发生结束时间',
      statement_time_start: '记录开始时间',
      statement_time_end: '记录结束时间',
      memory_summary_time_start: '记录开始时间',
      memory_summary_time_end: '记录结束时间',
      last7Days: "最近7天",
      last30Days: "最近30天",
      last1Year: "最近1年",
      ...
      emotionTime: {
        ...
        summary: '{{dialogues}} 条 Dialogue · {{emotions}} 类情绪 · {{days}} 个活跃日',
        overview: '数据概览',
        timeline: '情绪时间轴',
        noTimeline: '暂无情绪时间轴',
        noData: '暂无情绪数据',
        noTimelineDescription: '当前没有可用于生成时间轴的 Dialogue 情绪记录',
        noDataDescription: '当前没有可用于分析的 Dialogue 情绪记录',
        coreInsight: '核心结论',
        sparseWarning: '低样本提醒',
        singleDayData: '仅一天数据',
        dominantEmotionShift: '主导情绪迁移',
        singleInsight: '当前只有 1 个活跃日，可以查看当日构成，暂不生成跨日期变化结论。',
        sparseInsight: '{{date}}仅记录 {{count}} 条 Dialogue，不参与主导情绪迁移或集中度判断。',
        stableInsight: '主导情绪保持为{{emotion}}，整体情绪结构相对稳定。',
        shiftInsight: '后一个活跃日由{{from}}转为{{to}}，情绪结构发生迁移。',
        insufficientSamples: '样本不足',
        structure: '当日情绪结构',
        structureComparison: '情绪结构对比',
        countSummary: '{{count}} 条 · {{types}} 类',
        tooFewCountSummary: '{{count}} 条 · 样本极少',
        analysisDisclaimer: '只表达类别构成与变化；分类置信度不等于情绪强度。',
        timeOrder: '时间顺序',
        chronological: '时间正序',
        latestFirst: '最新优先',
        collapseAll: '全部收起',
        expandAll: '全部展开',
        dialogueCount: '{{count}} 条 Dialogue',
        distributionScattered: '情绪类型较分散，以{{first}}{{second}}为主。',
        distributionConcentrated: '情绪类型较集中，以{{first}}{{second}}为主。',
        emotionSeparator: '、',
        moreTypes: '{{count}} 类',
        collapsedGap: '{{days}} 天无 Dialogue，时间轴已折叠',
        colorBarHint: '色条表示当天各类情绪占比',
        tooltip: '{{name}}<br/>{{count}} 条 · {{ratio}}%',
        topThree: 'TOP 3',
        lowSample: '样本较少',
        emotionCount: '{{count}} 条',
        emotions: {
          anxiety: '焦虑',
          relief: '释然',
          hope: '希望',
