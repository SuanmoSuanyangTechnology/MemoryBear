export const userMemory = {
    userMemory: {
      ...
      memory_summary: 'Long-Term Accumulation',
      long_term_memory: 'Long-Term Accumulation',
      recording: 'Recording',
      occurred: 'Occurred',
      ...
      activeMemoryCount: 'Active Memories',
      ...
      occurred_asc: 'Occurred Ascending',
      occurred_desc: 'Occurred Descending',
      recorded_asc: 'Recorded Ascending',
      recorded_desc: 'Recorded Descending',
      all_time_start: 'Start Time',
      all_time_end: 'End Time',
      key_node_time_start: 'Occurrence Start',
      key_node_time_end: 'Occurrence End',
      statement_time_start: 'Record Start',
      statement_time_end: 'Record End',
      memory_summary_time_start: 'Record Start',
      memory_summary_time_end: 'Record End',
      ...
      emotionTime: {
        ...
        description: 'Emotion scores represent model classification confidence, not emotion intensity',
        summary: '{{dialogues}} Dialogues · {{emotions}} emotions · {{days}} active days',
        overview: 'Overview',
        timeline: 'Emotion Timeline',
        noTimeline: 'No emotion timeline',
        noData: 'No emotion data',
        noTimelineDescription: 'No Dialogue emotion records are available for generating a timeline.',
        noDataDescription: 'No Dialogue emotion records are available for analysis.',
        coreInsight: 'Key insight',
        sparseWarning: 'Low sample warning',
        singleDayData: 'Single-day data',
        dominantEmotionShift: 'Dominant emotion shift',
        singleInsight: 'There is only 1 active day. You can view its composition, but no cross-date conclusion will be generated.',
        sparseInsight: 'Only {{count}} Dialogues were recorded on {{date}}; this day is excluded from dominant-emotion shift and concentration analysis.',
        stableInsight: '{{emotion}} remained the dominant emotion, and the overall emotional structure was relatively stable.',
        shiftInsight: 'The dominant emotion shifted from {{from}} to {{to}} on the next active day.',
        insufficientSamples: 'Insufficient samples',
        structure: 'Daily emotion structure',
        structureComparison: 'Emotion structure comparison',
        countSummary: '{{count}} records · {{types}} types',
        tooFewCountSummary: '{{count}} records · Few samples',
        analysisDisclaimer: 'This view shows category composition and change only; classification confidence does not equal emotion intensity.',
        ...
        distributionScattered: 'Emotions are relatively scattered, led by {{first}}{{second}}.',
        distributionConcentrated: 'Emotions are relatively concentrated, led by {{first}}{{second}}.',
        emotionSeparator: ' and ',
        moreTypes: '{{count}} types',
        collapsedGap: '{{days}} days without Dialogue; timeline collapsed',
        colorBarHint: 'The color bar shows the share of each emotion for the day',
        tooltip: '{{name}}<br/>{{count}} records · {{ratio}}%',
        topThree: 'TOP 3',
        lowSample: 'Low sample',
        emotionCount: '{{count}} records',
        emotions: {
          anxiety: 'Anxiety',
          relief: 'Relief',
          hope: 'Hope',
