export const knowledgeBase = {
    knowledgeBase: {
      ...
      edit: 'Edit',
      copy: 'Copy',
      copyKnowledgeBase: 'Copy Knowledge Base',
      ...
      qaMode: 'QA Mode',
      imageParsingSettings: 'Image Parsing Settings',
      imageParsingSettingsDesc: 'If the uploaded content contains images, select the matching parsing strategy',
      textImage: 'Text Image',
      textImageDesc: 'Scans, screenshots, and receipts parsed with OCR',
      textImageTipsTitle: 'What is a text image?',
      textImageTipsDesc: 'The image mainly consists of readable text, such as scanned contracts, document screenshots, invoices, and receipts. The system prioritizes OCR to extract text, paragraphs, and layout order.',
      textImageTipsSample: 'Text image example: text conveys the primary information',
      hybridImage: 'Hybrid Image',
      hybridImageDesc: 'Charts, flowcharts, and posters parsed with OCR and visual understanding',
      hybridImageTipsTitle: 'What is a hybrid image?',
      hybridImageTipsDesc: 'Text and graphics jointly convey information, such as charts, flowcharts, and product posters. The system combines OCR with visual understanding to interpret text and relationships between elements.',
      hybridImageTipsSample: 'Hybrid image example: text and graphics jointly convey information',
      pureImage: 'Pure Image',
      pureImageDesc: 'Photos and illustrations without text described by a visual model',
      pureImageTipsTitle: 'What is a pure image?',
      pureImageTipsDesc: 'The primary information comes from visual content with little or no text, such as people, products, buildings, or landscape photos. The system uses a visual model to generate searchable image descriptions.',
      pureImageTipsSample: 'Pure image example: visual content conveys the primary information',
      ...
      createForm:{
        ...
        audio2text_id: 'Audio',
        video2text_id: 'Video',
        multimodalModel: 'Multimodal model inherits the workspace-configured model when not configured',
        permission_id: 'Permission',
        type: 'Type',
        status: 'Status',
