 ...
 * @Last Modified time: 2026-06-04 15:32:52
 */
/**
 * Conversation Page
...
import { getConversationHistory, sendConversation, getConversationDetail, getShareToken, getExperienceConfig, feedbackMessage,
  interventionsSubmit, interventionsResumeSubmit,
          ...
          switch (item.event) {
            ...
            case 'intervention_timeout':
              setChatList(prev => {
                ...
                const filterIndex = lastMsg.interventions.findIndex(item => item.node_id === nodeId)
                lastMsg.interventions[filterIndex] = {
                  ...lastMsg.interventions[filterIndex],
                  resolved_action_id: '__timeout__',
                  resolved_kind: 'timeout'
