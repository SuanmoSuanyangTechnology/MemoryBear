...
const ToolbarExtra: FC<ToolbarExtraProps> = ({ ctx }) => {
  ...
  const {
    features, isDeepThinking, isHasMemory, thinking, webSearch, memory, config,
    handleChangeDeepThinking, setWebSearch, handleChangeMemory,
  } = ctx
