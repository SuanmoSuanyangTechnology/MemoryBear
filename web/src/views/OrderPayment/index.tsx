 ...
 * @Last Modified time: 2026-08-14 17:14:24
 */
/**
 * Order Payment Page
...
const OrderPayment: React.FC = () => {
  ...
  return (
    ...
    >
      <Flex vertical gap={16} className="rb:h-full! rb:overflow-hidden!">
        {(upgradePreview) &&
          <Flex gap={24} align="center" justify="space-between" className="rb:bg-white rb:rounded-2xl rb:px-4! rb:py-2!">
        ...
        {(jumpFrom === 'renewal') &&
          <Flex align="center" justify="space-between" className="rb:bg-white rb:rounded-2xl rb:px-4! rb:py-2!">
        ...
        <div className="rb:flex-1! rb:overflow-y-auto rb:bg-white rb:rounded-lg rb:py-3 rb:px-3">
          {/* Order Information */}
