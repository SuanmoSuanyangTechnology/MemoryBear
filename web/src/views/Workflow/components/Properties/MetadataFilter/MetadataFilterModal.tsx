...
const operatorsObj: { [key: string]: SelectProps['options'] } = {
  default: [
    ...
    { value: 'starts_with', label: 'workflow.config.knowledge-retrieval.starts_with' },
    { value: 'ends_with', label: 'workflow.config.knowledge-retrieval.ends_with' },
    { value: 'is_empty', label: 'workflow.config.knowledge-retrieval.is_empty' },
    { value: 'not_empty', label: 'workflow.config.if-else.not_empty' },
    { value: 'in', label: 'workflow.config.knowledge-retrieval.in' },
    { value: 'not_in', label: 'workflow.config.knowledge-retrieval.not_in' },
  ],
  number: [
